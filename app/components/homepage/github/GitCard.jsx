...
function GitCard({ repo }) {
  ...
  return (
    <Link href={repo.html_url}  target='_blank' className="border border-[#1d293a] hover:border-[#464c6a] transition-all duration-500 bg-[#1b203e] rounded-lg relative group"
    >
      <div className="h-44 lg:h-52 w-auto cursor-pointer overflow-hidden rounded-t-lg">
       {(repo?.avatar_url || img) ? <Image
